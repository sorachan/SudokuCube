 ...
 */
public class SlnDialog extends javax.swing.JDialog {

    /**
     * Creates new form SlnDialog
     * @param parent
     * @param modal
     */

    public SlnDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("SOLUTION")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SlnDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                SlnDialog dialog = new SlnDialog(new javax.swing.JFrame(), true);
